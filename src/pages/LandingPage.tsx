        ...
        <section className="py-20 md:py-32 bg-gradient-to-b from-blue-light to-background">
          <div className="container flex flex-col items-center text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mb-10">
              Health-Chain Nexus gives you complete ownership of your medical history through
          ...
          <div className="container">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-muted-foreground">
                Health-Chain Nexus combines the power of blockchain with healthcare to create a secure, patient-centered ecosystem.
              </p>
            </div>
        ...
        <section id="about" className="py-20 bg-muted/30">
          <div className="container">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-4">About Health-Chain Nexus</h2>
                <p className="text-muted-foreground mb-6">
                  Health-Chain Nexus represents a paradigm shift in healthcare record management. By leveraging blockchain technology, we empower patients with unprecedented control over their medical data.
                </p>
                <p className="text-muted-foreground mb-6">
        ...
        <section id="security" className="py-20">
          <div className="container">
            ...
            <div className="mt-16 text-center">
              <Button size="lg" asChild>
                <Link to="/dashboard">Start Using Health-Chain</Link>
              </Button>
            </div>
          </div>
        </section>
